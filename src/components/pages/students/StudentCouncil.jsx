...
const StudentCouncil = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`https://physical-academy-backend-3dccb860f75a.herokuapp.com/api/students/council/?lang=${i18n.language}`);
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-blue-900 via-cyan-900 to-green-900 py-16 lg:py-24 overflow-hidden">
      {/* Анимированный фон */}
